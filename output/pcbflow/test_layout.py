...
_a = J1.pads[0]
_b = R1.pads[0]
if hasattr(brd, 'route_wire'):
    brd.route_wire([_a, _b], 0.25)
else:
    try:
        brd.trace(_a.at, _b.at, w=0.25, layer='top')
    except Exception:
        pass
...
_b = D1.pads[0]
if hasattr(brd, 'route_wire'):
    brd.route_wire([_a, _b], 0.152)
else:
    try:
        brd.trace(_a.at, _b.at, w=0.152, layer='top')
    except Exception:
        pass
